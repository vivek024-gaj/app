...
import in.cropdata.app.filter.JwtAuthenticationEntryPoint;
import in.cropdata.app.filter.JwtRequestFilter;
...
//    }
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.csrf().disable()
				...
				.permitAll().antMatchers("/**").permitAll()// comment this before commit to dev server
